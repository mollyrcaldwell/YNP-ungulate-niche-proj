...
lf <- list.files("~/UWyo/PhD project/HOTR-proj/Data/GIS data/", pattern = glob2rx("SNODAS_2021*SnowDepth*"), full.names = TRUE)
...
stackSave(SnowOff_jul, "./Code output/Season Rasters/snowOFF_julday.stk")
...
stackSave(SnowOn_jul, "./Code output/Season Rasters/snowON_julday.stk")
...
```{r}
#load rasters
snowOn <- stackOpen("./Code output/Season Rasters/snowON_julday.stk")
snowOff <- stackOpen("./Code output/Season Rasters/snowOFF_julday.stk")
