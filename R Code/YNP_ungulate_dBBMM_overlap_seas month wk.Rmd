...
clusterExport(clust, varlist=c("sp_all"))
...
for(i in 1:length(u_seasyr)){
  ...
  #separate out data that has seas_yr (str_detect b/c elk strings have additional data)
sp_sub <- sp_all[str_detect(sp_all$seas_yr, u_seasyr[i]), ]
...
HR_ol_comb <- read.csv("./Code output/dBBMM_UDs/dbbdm_allHR_overlap_seas_yr_8.31.22.csv")
```
